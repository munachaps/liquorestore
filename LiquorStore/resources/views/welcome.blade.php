...
<head>
    ...
    <title>
        LiqourMart - For all your liquor deliveries
    </title>
    <meta name="author" content="KingChaps" />
    <meta name="description" content="LiquorMart - For all your liquor supplies" />
    <meta name="keywords" content="LiquorMart - For all your liquor supplies" />
    ...
    <link href="../../../../fonts.googleapis.com/css2a111.css?family=Lobster+Two:wght@400;700&amp;family=Roboto:wght@100;300;400;500;700&amp;family=Rubik:wght@300;400;500;600;700;800;900&amp;display=swap" rel="stylesheet" />
...
<body>
        ...
        <div class="container bg-white">
            <div class="row">
              ...
              <div class="actions">
                ...
                >
                <span
                  >Tags: <a href="shop.html">Fast Food</a
                  ><a href="shop.html">Grill</a></span
                >
              </div>
              <div class="share">
                <p class="share-title">
          ...
          <div class="widget_shopping_cart_content">
            <ul class="woocommerce-mini-cart cart_list product_list_widget">
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="assets/img/menu/menu_thumb_1_1.png"
                    alt="Cart Image"
                  />Daria Shevtsova</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="assets/img/menu/menu_thumb_1_2.png"
                    alt="Cart Image"
                  />Chicken Masala</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="assets/img/menu/menu_thumb_1_3.png"
                    alt="Cart Image"
                  />Sicilian Pizza</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="assets/img/menu/menu_thumb_1_4.png"
                    alt="Cart Image"
                  />Beef Masala</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="assets/img/menu/menu_thumb_1_5.png"
                    alt="Cart Image"
                  />Martin Widenka</a
                >
                <span class="quantity"
      ...
      <div class="th-menu-area text-center">
        ...
        <div class="th-mobile-menu">
          <ul>
            <li class="menu-item-has-children">
              <a href="index.html">BEERS AND CIDERS</a>
              <ul class="sub-menu">
                <li><a href="home-restaurant.html">Restaurant Home</a></li>
                <li>
                  <a href="home-fast-food-rastaurant.html"
                ...
                <li>
                  <a href="home-tea-coffee.html"
                    >Tea Coffee Home <span class="new-label">New</span></a>
                            </li>
                            <li>
                ...
                <li>
                  <a href="home-fast-food-v2.html"
                    >Fast Food Home <span class="new-label">SPIRITS</span></a
                  >
                </li>
                <li>
                  <a href="home-pizza-burger.html"
                    >Pizza & Burger Light <span class="new-label">New</span></a
                  >
                </li>
                <li>
                  <a href="home-pizza-burger-dark.html"
                    >Pizza & Burger Dark <span class="new-label">New</span></a
                  >
                </li>
              </ul>
            </li>
            <li class="menu-item-has-children">
              <a href="#">Menu</a>
                ...
                <div class="d-none d-md-block">
                    <div id="slider" class="ls-wp-container fitvidsignore hero-7 th-hero-carousel" style="width: 1920px; height: 900px; margin: 0 auto">
                        <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:5000; transition2d:11; kenburnszoom:in; kenburnsscale:1.2;">
                            <img width="1920" height="900" src="assets/img/bg/braaiandbeer.jpeg" class="ls-bg" alt="" decoding="async" />
                            <ls-layer style="
              font-size: 36px;
              color: #000;
              stroke: #000;
            ...
            " class="ls-l ls-svg-layer" data-ls="static:forever;"><svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 1920 900" fill="none">
              <rect
                width="1920"
                height="900"
              ...
              left: 50%;
              -webkit-background-clip: border-box;
            " class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer" data-ls="offsetyin:-300; durationin:1200; delayin:200; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-200; durationout:400; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent;">Special Fast food restaurant</ls-layer>
                            <h1 style="
              text-align: left;
              text-decoration: none;
              ...
              line-height: 130px;
              white-space: normal;
            " class="ls-l ls-hide-phone ls-text-layer" data-ls="offsetyin:-300; durationin:1200; delayin:200; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-200; durationout:400; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent;">
                                Best Quality
                            </h1>
                            <h1 style="
              text-align: left;
              ...
              color: #ffffff;
              white-space: normal;
            " class="ls-l hero-title ls-hide-phone ls-text-layer" data-ls="offsetyin:-300; durationin:1200; delayin:400; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-200; durationout:400; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent;">
                                Fast Food
                            </h1>
                            <a style="" class="ls-l ls-hide-tablet ls-hide-phone" href="shop.html" target="_self" data-ls="offsetyin:-300; durationin:1200; delayin:500; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-120; durationout:800; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent; hover:true; hoveropacity:1; hoverbgcolor:#ffffff; hovercolor:#ff0600;">
                                <ls-layer style="
                font-size: 14px;
                color: #fff;
                text-align: center;
              ...
              " class="ls-ib-icon ls-button-layer">Explore menu<i class="fa fa-arrow-right" style="margin-left: 0.5em; font-size: 1em"></i></ls-layer>
                            </a>
                            <ls-layer style="
              stroke: #000;
              stroke-width: 0px;
              ...
              left: 50%;
              -webkit-background-clip: border-box;
            " class="ls-l ls-hide-desktop ls-text-layer" data-ls="offsetyin:-300; durationin:1200; delayin:200; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-200; durationout:400; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent;">Special Fast food restaurant</ls-layer>
              ...
              " class="ls-ib-icon ls-button-layer">Explore menu<i class="fa fa-arrow-right" style="margin-left: 0.5em; font-size: 1em"></i></ls-layer>
                        ...
                        <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:5000; transition2d:11; kenburnszoom:in; kenburnsscale:1.2;">
                            <img width="1920" height="900" src="assets/img/bg/spirits.jpeg" class="ls-bg" alt="" decoding="async" />
                            <ls-layer style="
              font-size: 26px;
              stroke: #000;
              stroke-width: 0px;
            ...
            " class="ls-l ls-hide-desktop ls-text-layer" data-ls="offsetyin:-300; durationin:1200; delayin:200; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-200; durationout:400; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent;">Special Fast food restaurant</ls-layer>
              ...
              " class="ls-ib-icon ls-button-layer">Explore menu<i class="fa fa-arrow-right" style="margin-left: 0.5em; font-size: 1em"></i></ls-layer>
                        ...
                        <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:5000; transition2d:11; kenburnszoom:in; kenburnsscale:1.2;">
                            <img width="1920" height="900" src="assets/img/bg/wineandpeople.jpeg" class="ls-bg" alt="" decoding="async" />
                            <ls-layer style="
              font-size: 26px;
              stroke: #000;
              stroke-width: 0px;
            ...
            " class="ls-l ls-hide-desktop ls-text-layer" data-ls="offsetyin:-300; durationin:1200; delayin:200; easingin:easeOutBack; bgcolorin:transparent; colorin:transparent; offsetxout:-200; durationout:400; startatout:slidechangeonly + ; bgcolorout:transparent; colorout:transparent;">Special Fast food restaurant</ls-layer>
              ...
              " class="ls-ib-icon ls-button-layer">Explore menu<i class="fa fa-arrow-right" style="margin-left: 0.5em; font-size: 1em"></i></ls-layer>
                ...
                <div class="d-block d-md-none">
                    <div id="slider-phone" class="ls-wp-container fitvidsignore hero-7 th-hero-carousel" style="width: 500px; height: 600px; margin: 0 auto">
                        <div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:5000; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                            <img width="500" height="600" src="assets/img/bg/drinksandjuices.jpeg" class="ls-bg" alt="" decoding="async" />
                            <ls-layer style="
              font-size: 36px;
              color: #000;
              stroke: #000;
              ...
              height: 600px;
              -webkit-background-clip: border-box;
            " class="ls-l ls-svg-layer" data-ls="static:forever;"><svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 500 600" fill="none">
              <rect
                width="500"
                height="600"
                fill="url(#paint0_radial_2726_7139)"
                fill-opacity="0.85"
              ></rect>
              <defs>
                <radialgradient
                  id="paint0_radial_2726_7139"
                  cx="0"
                  cy="0"
                  r="1"
                  gradientunits="userSpaceOnUse"
        ...
        >
          <img
            width="500"
            height="600"
            src="assets/img/update_2/hero/hero_bg_7_1_2.jpg"
            class="ls-bg"
            alt=""
            decoding="async"
          />
    ...
    <div class="space">
      ...
      <div class="container">
        <div class="title-area text-center">
          <span class="sub-title">We have got it all</span>
        ...
        >
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/absolute-vodka-blue-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
                <a href=" ">Beef Barger</a>
              </h3>
              <div class="fire">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/afdis-count-pushkin-vodka-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/johnnie-walker-blue-label-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/ciroc-vodka-apple-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/johnnie-walker-green-label-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/skyy-vodka-original-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm2">
            <div class="category-border">
              <div class="category-border_img">
                <img
                  src="assets/img/gas/doltec-remy-martin-vsop-cognac-750ml.jpeg"
                  alt="Image"
                />
              </div>
              <h3 class="category-border_title">
        ...
        <div class="row">
          <div class="col-xl-6">
            <div class="img-box8">
              <div class="img1">
                <img
                  src="assets/img/update_2/normal/about_8_1.png"
                  alt="About"
                />
              </div>
              <div class="img2 jump">
                <img
                  src="assets/img/update_2/shape/red_chili_2.png"
                  alt="About"
                />
              </div>
              <div class="about-box">
                ...
                <div class="about-box_avaters">
                  <img
                    src="assets/img/update_2/normal/about_7_3.png"
                    alt="About"
                  />
                </div>
              </div>
            ...
            <div class="ps-xxl-5 ms-xl-2">
              ...
              <div class="about-award">
                <div class="about-award_icon">
                  <img
                    src="assets/img/update_2/icon/about-award.svg"
                    alt="Icon"
                  />
                </div>
              ...
              <div
                class="btn-group mt-35 justify-content-center justify-content-xl-start"
              >
                <a href="about.html" class="th-btn rounded-2"
                  >ABOUT MORE<i class="fa-solid fa-arrow-right ms-2"></i
                ></a>
                <div class="about-profile">
                  <div class="about-avater">
                    <img
                      src="assets/img/update_2/shape/about-thumb_1.png"
                      alt="about"
                    />
                  </div>
                  <div class="media-body">
    ...
    <section
      class="bg-top-center position-relative"
      id="productMenu"
      data-bg-src="assets/img/update_2/bg/menu_bg_6.jpg"
    >
      <div class="container">
          ...
          <div class="row">
                  ...
                  <div class="food-menu-list border-md">
                    <div class="food-menu">
                      <div class="food-menu_img">
                        <img
                          src="assets/img/update_2/menu/menu_2_1.png"
                          alt="Menu"
                        />
                      </div>
                    ...
                    <div class="food-menu">
                      <div class="food-menu_img">
                        <img
                          src="assets/img/update_2/menu/menu_2_2.png"
                          alt="Menu"
                        />
                      </div>
                      <div class="food-menu_content">
                    ...
                    <div class="food-menu">
                      <div class="food-menu_img">
                        <img
                          src="assets/img/update_2/menu/menu_2_3.png"
                          alt="Menu"
                        />
                      </div>
                      <div class="food-menu_content">
                ...
                <div class="col-lg-6">
                  <div class="food-menu-list">
                    <div class="food-menu">
                      <div class="food-menu_img">
                        <img
                          src="assets/img/update_2/menu/menu_2_4.png"
                          alt="Menu"
                        />
                      </div>
                      <div class="food-menu_content">
                    ...
                    <div class="food-menu">
                      <div class="food-menu_img">
                        <img
                          src="assets/img/update_2/menu/menu_2_5.png"
                          alt="Menu"
                        />
                      </div>
                      <div class="food-menu_content">
                    ...
                    <div class="food-menu">
                      <div class="food-menu_img">
                        <img
                          src="assets/img/update_2/menu/menu_2_6.png"
                          alt="Menu"
                        />
                      </div>
                      <div class="food-menu_content">
            ...
            <div class="col-xl-4 mt-40 mt-xl-0">
              <div
                ...
                data-bg-src="assets/img/update_2/normal/image_menu_bg.jpg"
              >
                <div
                  class="discount_style4"
                  data-bg-src="assets/img/update_2/shape/discount_bg_1.svg"
                >
                ...
                <div class="img1">
                  <img
                    src="assets/img/update_2/normal/image_menu_2.png"
                    alt="About"
                  />
                </div>
              </div>
    ...
    <section class="" data-pos-for="#testiSec" data-sec-pos="bottom-half">
      <div class="container">
        <div
          class="row justify-content-center justify-content-lg-between align-items-end"
        >
          ...
          <div class="col-auto">
            <div class="sec-btn text-center">
              <div class="icon-box">
                <button
                  data-slick-prev="#gallerySlide1"
                  class="slick-arrow default"
                >
                  <i class="far fa-arrow-left"></i>
                </button>
                <button
                  data-slick-next="#gallerySlide1"
                  class="slick-arrow default"
                >
          ...
          >
            <div class="col-xxl-auto col-md-6">
              <div class="gallery-card style2 mb-0">
                <div class="gallery-img">
                  <img
                    src="assets/img/update_2/gallery/gallery_4_1.jpg"
                    alt="gallery image"
                  />
                </div>
                <div class="gallery-content">
                  ...
                  <a
                    href="assets/img/update_2/gallery/gallery_4_1.jpg"
            ...
            <div class="col-xxl-auto col-md-6">
              <div class="gallery-card style2 mb-0">
                <div class="gallery-img">
                  <img
                    src="assets/img/update_2/gallery/gallery_4_2.jpg"
                    alt="gallery image"
                  />
                </div>
                <div class="gallery-content">
                  ...
                  <a
                    href="assets/img/update_2/gallery/gallery_4_2.jpg"
                    class="icon-btn popup-image"
                    ><i class="fas fa-plus"></i
                  ></a>
                </div>
            ...
            <div class="col-xxl-auto col-md-6">
              <div class="gallery-card style2 mb-0">
                <div class="gallery-img">
                  <img
                    src="assets/img/update_2/gallery/gallery_4_3.jpg"
                    alt="gallery image"
                  />
                </div>
                <div class="gallery-content">
                  ...
                  <a
                    href="assets/img/update_2/gallery/gallery_4_3.jpg"
                    class="icon-btn popup-image"
                    ><i class="fas fa-plus"></i
                  ></a>
                </div>
            ...
            <div class="col-xxl-auto col-md-6">
              <div class="gallery-card style2 mb-0">
                <div class="gallery-img">
                  <img
                    src="assets/img/update_2/gallery/gallery_4_4.jpg"
                    alt="gallery image"
                  />
                </div>
                <div class="gallery-content">
                  ...
                  <a
                    href="assets/img/update_2/gallery/gallery_4_4.jpg"
                    class="icon-btn popup-image"
                    ><i class="fas fa-plus"></i
                  ></a>
                </div>
            ...
            <div class="col-xxl-auto col-md-6">
              <div class="gallery-card style2 mb-0">
                <div class="gallery-img">
                  <img
                    src="assets/img/update_2/gallery/gallery_4_5.jpg"
                    alt="gallery image"
                  />
                </div>
                <div class="gallery-content">
                  ...
                  <a
                    href="assets/img/update_2/gallery/gallery_4_5.jpg"
                    class="icon-btn popup-image"
                    ><i class="fas fa-plus"></i
                  ></a>
                </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-xl-4 text-center text-xl-start">
            ...
            <div class="icon-box">
              <button
                data-slick-prev="#testiSlide3"
                class="slick-arrow default"
              >
                <i class="far fa-arrow-left"></i>
              </button>
              <button
                data-slick-next="#testiSlide3"
                class="slick-arrow default"
              >
                <i class="far fa-arrow-right"></i>
              </button>
              ...
              <div class="col-xl-4 col-lg-6">
                <div class="testi-block">
                  <div class="testi-block_shape">
                    <img
                      src="assets/img/update_2/bg/testi-block_bg.png"
                      alt="BG"
                    />
                  </div>
                  <div class="testi-block_profile">
                    <div class="testi-block_avater">
                      <img
                        src="assets/img/update_2/normal/testi_4_1.jpg"
                        alt="Avater"
                      />
                      <div class="testi-block_quote">
                        <img
                          src="assets/img/update_2/icon/quote_1.svg"
                          alt="Icon"
                        />
                      </div>
                    </div>
              ...
              <div class="col-xl-4 col-lg-6">
                <div class="testi-block">
                  ...
                  <div class="testi-block_profile">
                    <div class="testi-block_avater">
                      <img
                        src="assets/img/update_2/normal/testi_4_2.jpg"
                        alt="Avater"
                      />
                      <div class="testi-block_quote">
                        <img
              ...
              <div class="col-xl-4 col-lg-6">
                <div class="testi-block">
                  ...
                  <div class="testi-block_profile">
                    <div class="testi-block_avater">
                      <img
                        src="assets/img/update_2/normal/testi_4_3.jpg"
                        alt="Avater"
                      />
                      <div class="testi-block_quote">
                        <img
        ...
        >
          <div class="col-md-6 col-xl-4">
            <div class="blog-list">
              <div class="blog-img">
                <img
                  src="assets/img/update_2/blog/blog_3_1.jpg"
                  alt="blog image"
                />
              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  <a href="blog.html"
                    ><i class="fa-light fa-calendar-days"></i>15 July, 2023</a
                  >
                  <a href="blog.html"
                    ><i class="fa-regular fa-comments"></i>3 Comments</a
                  >
                </div>
                ...
                <a href="blog-details.html" class="th-btn rounded-2"
          ...
          <div class="col-md-6 col-xl-4">
            <div class="blog-list">
              <div class="blog-img">
                <img
                  src="assets/img/update_2/blog/blog_3_2.jpg"
                  alt="blog image"
                />
              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  <a href="blog.html"
                    ><i class="fa-light fa-calendar-days"></i>16 July, 2023</a
                  >
                  <a href="blog.html"
                    ><i class="fa-regular fa-comments"></i>3 Comments</a
                  >
          ...
          <div class="col-md-6 col-xl-4">
            <div class="blog-list">
              <div class="blog-img">
                <img
                  src="assets/img/update_2/blog/blog_3_3.jpg"
                  alt="blog image"
                />
              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  <a href="blog.html"
                    ><i class="fa-light fa-calendar-days"></i>17 July, 2023</a
                  >
                  <a href="blog.html"
                    ><i class="fa-regular fa-comments"></i>3 Comments</a
                  >
                ...
                <h3 class="box-title blog-title">
                  <a href="blog-details.html"
                    >Innovative Hot Chessy raw Pasta Make Creator.</a
                  >
                </h3>
                <p class="blog-text">
                  Statement underscores the value of thinking Outside the box
          ...
          <div class="col-md-6 col-xl-4">
            <div class="blog-list">
              <div class="blog-img">
                <img
                  src="assets/img/update_2/blog/blog_3_4.jpg"
                  alt="blog image"
                />
              </div>
              <div class="blog-content">
                <div class="blog-meta">
                  <a href="blog.html"
                    ><i class="fa-light fa-calendar-days"></i>21 July, 2023</a
                  >
                  <a href="blog.html"
                    ><i class="fa-regular fa-comments"></i>3 Comments</a
                  >
                ...
                <h3 class="box-title blog-title">
                  <a href="blog-details.html"
                    >Best Hot Chessy raw In Pasta Makeing Trick.</a
                  >
                </h3>
                <p class="blog-text">
                  Statement underscores the value of thinking Outside the box
    ...
    <section
      class="bg-smoke2 py-5"
      data-bg-src="assets/img/update_2/bg/newsletter_bg_2.png"
    >
      <div
    ...
    <footer
      ...
      data-bg-src="assets/img/update_2/bg/footer_bg_7.png"
    >
              ...
              <div class="widget footer-widget">
                ...
                <div class="th-widget-contact">
                  ...
                  <div class="info-box">
                    ...
                    <p class="info-box_text">
                      <a href="tel:+11234567890" class="info-box_link"
                        >+(1) 123 456 7890</a
                      >
                      <a href="tel:+10987654321" class="info-box_link"
                        >+(1) 098 765 4321</a
                      >
                    </p>
                  </div>
                  <div class="info-box">
                    ...
                    <p class="info-box_text">
                      <a href="mailto:info@pizzan.com" class="info-box_link"
                        >info@pizzan.com</a
                      >
                      <a
                        href="mailto:info.example@pizzan.com"
                        class="info-box_link"
...
<!-- Mirrored from themeholy.com/html/pizzan/demo/home-fast-food.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jan 2024 08:37:10 GMT -->
